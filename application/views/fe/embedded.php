...
<head>
  <meta charset="utf-8">
  <title>Embedded Firmware Design - VolenTech</title>  
...
<body>
  <div style="opacity:0" class="page-wrapper">
    ...
    <section class="section service-hero wf-section">
      <div class="container-default w-container">
        <div class="service-hero-content">
          <h1 data-w-id="fd85e6d6-892f-ebcc-e259-e65fe381bc3e" style="-webkit-transform:translate3d(0, 0, 0) scale3d(0.9, 0.9, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 0, 0) scale3d(0.9, 0.9, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 0, 0) scale3d(0.9, 0.9, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 0, 0) scale3d(0.9, 0.9, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);opacity:0" class="title service-hero">Embedded Firmware Design</h1>
          <p data-w-id="39c27589-c071-1823-79f3-81caa90b1bf4" style="-webkit-transform:translate3d(0, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);opacity:0" class="paragraph-large service-hero">Embedded Systems is our primary area of expertise and we have a team of Doctorate level Firmware development Engineers with expertise in chip level firmware development.</p>          
        </div>
      </div>
      <div class="image-wrapper service-hero"><img src="<?php echo base_url('assets/images/image-service-hero-architecture-x-template.png');?>" loading="eager" data-w-id="d34bf91e-7a65-8b1a-621d-60e75515a515" sizes="(max-width: 991px) 100vw, 47vw" srcset="<?php echo base_url('assets/images/image-service-hero-architecture-x-template-p-500.png');?> 500w, <?php echo base_url('assets/images/image-service-hero-architecture-x-template.png');?> 1354w" alt="Our Services - Architecture X Webflow Template" class="image service-hero"></div>
    ...
    <section class="section bg-neutral-800 wf-section">
      <div data-w-id="4f1dc386-85c1-f302-3ad7-55c410150e39" style="-webkit-transform:translate3d(0, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);opacity:0" class="container-medium-840px">        
        ...
        <div class="rich-text-white w-richtext">
          <p>We offer complete Firmware design and development using a comprehensive testing methodology. We perform step by step debugging and unit testing of the code for future production level requirements.</p>
        </div>        
      </div>
      <div class="bg page-lines-wrapper">
    ...
    <section class="section wf-section">
      <div data-w-id="01ebaf8b-18b0-6075-34bb-b4114051d4d1" style="-webkit-transform:translate3d(0, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);opacity:0" class="container-small-502px service-testimonial">        
        <h2 class="title service-testimonial">Embedded Firmware Design Capabilities</h2>
      </div>
      <div class="container-default w-container">
        <div data-w-id="e3fa43d9-f7e2-3f07-4ec6-f633fd54207e" style="-webkit-transform:translate3d(0, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);opacity:0" class="testimonial-wrapper">
          <div class="description">
            <div class="header row">
              <div class="col-left">
                <h2 class="title h3-size ">Domain</h2>                
              </div>
              <div class="col-right">
                <h2 class="title h3-size ">Expertise</h2>
              </div>
            </div>
            <div class="content">
              <div class="row">
                <div class="col-left domain">
                  Micro-controller/<br>Miscroprocessors/<br>Integrated Chips/<br>Development Boards
                </div>
                <div class="col-right expertise">
                  <ul>
                    <li>ARM Cortex-M, AVR</li>
                    <li>NXPs S32K Series, Exas instruments TMS570, Nordic's NRF51/52 BLE</li>
                    <li>NXPs IMX6, IMX7, IMX8M Single Board Computer</li>
                    <li>Linear Technology LT8584, LT680x, LT681xSeries, SPI Driver Ics</li>
                    <li>IC design from Renesas, Microchip, Analog Devices, Maxim Integrated, TI etc.</li>
                    <li>Arduino Development, PIC micro-controller, ATMEL, STM32</li>
                    <li>ESP32, ESP3286, Zigbee, HM Family, SIMCOM, 7600/808 Cellular & GPS, Xbee3 LTE-M Cellar modules</li>
                  </ul>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-right expertise">
                  <ul>
                    <li>Qaurtus II, Xilinx, Vivado, synopsys VCS, Miscrosemi, Altera</li>
                    <li>Verilog, SystemVerilog, VHDL, tool chains</li>
                    <li>RTL Coding for ASIC implementation</li>
                  </ul>
                </div>
              </div>
              <div class="row">
                <div class="col-left domain">
                  Memory/Perpherals Interfaces
                </div>
                <div class="col-right expertise">
                  <ul>
                    <li>Camera CSI, Display DSI, VGA, HDMI, Ethernet, USB(micro-USB, OTG USB, USB-A, USB-C)</li>
                    <li>DDR3, SATA, PCle Gen3, 4 Bit PCI</li>
                    <li>I2C, SPI, UART, CAN, LIN, RS485, Rs232</li>
                  </ul>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-right expertise">
                  <ul>
                    <li>Digital Oscilloscopes(Active & Passive Probes), Digital Multi-meter, Logic Analyzer</li>
                    <li>Time-Domain Reflectometer(TDR)</li>
                    <li>JTAG Debugger, OPENSDA</li>
                  </ul>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-right expertise">
                  <ul>
                    <li>9 axis Gyroscope/Accelerometer/Magnetometer, Pressure Sensor, Temperature Sensor</li>
                    <li>Ultrasonic, Humidity Sensor, Encoders, Current and Voltage Snesors</li>
                  </ul>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-right expertise">
                  <ul>
                    <li>S32K Design, Code Composer, STM32 CubeIDE, Keil, IAR, VisualGBD, Auduino, MPLAB X, MikroC</li>                   
                  </ul>
                </div>
              </div>
            </div>
